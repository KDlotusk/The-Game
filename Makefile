...
sub-Client-qmake_all:  FORCE
	...
	cd Client/ && $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro
	cd Client/ && $(MAKE) -f Makefile qmake_all
sub-Client: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile
sub-Client-make_first: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile 
sub-Client-all: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile all
sub-Client-clean: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile clean
sub-Client-distclean: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile distclean
sub-Client-install_subtargets: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile install
sub-Client-uninstall_subtargets: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile uninstall
...
sub-Client-check:
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile check
...
sub-Client-benchmark:
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -f Makefile benchmark
...
sub-Client-distdir: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/nilmar/DUT/client-server/The-Game/Client/Client.pro ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/Client
